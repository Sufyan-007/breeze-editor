            ...
            <div className="container-fluid d-flex flex-column vh-100">
                ...
                <div className="row flex-grow-1 overflow-hidden">
                    <div className="col-3   overflow-y-auto h-100 fs-6 text-white" style={{ width: "18rem", backgroundColor: "#303033" }}>
                        <ServicePaths setSelected={setSelected} tags={serviceConfig?.tags} paths={serviceConfig?.paths} className="row my-2 border-bottom border-black" />
                        <SchemaConfig setSelected={setSelected} schemas={serviceConfig?.components.schemas} className="row my-2 border-bottom border-black" />
                    ...
                    <div className="col">
                        ...
                        {selected.type==="schema"?
                            <EntityConfig schema={serviceConfig.components.schemas} selectedEntity={selected.selected} />
                        :null}
                    </div>
                </div>
            </div>
