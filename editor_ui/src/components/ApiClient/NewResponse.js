...
function NewResponse({ responseData, onChange }) {
  ...
  const handleSelect = (selectedIndex) => {
    ...
    // if (responseData.length > 0) onChange("response", responseData);
  };
          ...
          {activeTab && responseData.length > 0 && (
            <>
              <div className="new-res-h-full new-res-d-flex  mt-2">
                <div
                  id="left"
                  className="new-res-h-full new-res-w-50 "
                ...
                <div id="right" className="new-res-h-full new-res-w-50">
                  <div
                    ...
                    <Form.Control
                      ...
                      onChange={(e)=>{handleChange("raw_content", e.target.value)}}
