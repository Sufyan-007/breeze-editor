  ...
  return (
    <div className="row h-100">
      <div className="d-flex mt-1">
        <i className="ms-2 me-auto" style={{ color: "#dee2e6" }}>
          Add Elements
        </i>
      ...
      <div className="col h-100" style={{ overflowY: "auto" }}>
        ...
        >
          <div className="card-header text-center ">
            {
              elementFilterOptions.filter((obj) => obj.value === chosenType)[0]
                .label
            }{" "}
            elements
          </div>
          <ul className="list-group list-group-flush">
              ...
              allElementOptions
                .filter(
                  (obj) =>
                    ...
                    (chosenType === "All" || chosenType === obj.type)
                )
                .map((component, index) => (
                  <li
                    key={index}
            ...
            {!searchedElement &&
              ...
              allElementOptions
                .filter(
                  (obj) => chosenType === "All" || obj.type === chosenType
                )
                .map((component, index) => (
                  <li
                    key={index}
