...
import WhileBlockEdit from "../../FunctionItemComponents/WhileBlock";
import { v4 as uuidv4 } from "uuid";

export default function WhileBlock({ config, updateParent }) {
  ...
  return (
    <>
        ...
        <div className="d-flex justify-content-between">
          <div className="d-flex">
            <div
              ...
              data-bs-target={`#collapse-while-${uniqueId}`}
      ...
      <Offcanvas
        ...
        title={"Edit While Block"}
        width="40%"
      >
        <div className="px-1 h-100 container">
          <WhileBlockEdit config={config} update={(val) => handleClose(val)} />
        </div>
      </Offcanvas>
    </>
  );
