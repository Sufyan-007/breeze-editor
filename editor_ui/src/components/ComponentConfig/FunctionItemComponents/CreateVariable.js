  ...
  useEffect(() => {
    ...
    if (isCustomValue) {
      switch (variableInfo.dataType) {
        case "OBJECT":
          try {
            valueObject = { type: "OBJECT", properties: JSON.parse(variableInfo.value) };
          } catch (e) {
          ...
          break;
        default:
          valueObject = { type: variableInfo.dataType, value: variableInfo.value };
      }
    } else {
    ...
    <div className="px-1 py-2">
      <form className="variable-declaration-form">
        ...
        <div className="form-group mb-2 d-flex align-items-center">
          <label htmlFor="customValueSwitch" className="me-2">Value Type</label>
