...
function RenderObject({ propertyName, value, updateParent, depth = 0 }) {
  ...
  useEffect(()=>{setName(propertyName)},[propertyName])
  const addProperty = () => {
  ...
  return (
    <>
      <Card
        ...
        {isExpanded && (
          <>
            <Card.Body className="text-white d-flex justify-content-between">
              <div style={{ width: "30%" }}>
              ...
              {val.type === "object" && val.objectType === "custom" && (
                <div className="text-white">
                  <div className="d-flex">
                    <span className="text-white">Sub Properties</span>
                    <img
                      className="mx-2 mb-1"
                      width="25"
                      height="25"
