...
def create_json_structure(directory_manager, folder_path, parent_id=None, tag='ROOT'):
    ...
    for item in folder_contents:
        ...
        if os.path.isdir(item_path):
            ...
            create_json_structure(directory_manager, item_path, parent_id=folder_id, tag="ZIP")
        else:
