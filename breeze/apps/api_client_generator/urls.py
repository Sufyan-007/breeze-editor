...
urlpatterns = [
        ...
        path('modified-intermediate-json/<str:projectName>/<str:filename>', csrf_exempt(ModifyIntermediateJson.as_view())),
        path('fetch-all-intermediates/<str:projectName>/<str:files_only>', csrf_exempt(ApiClientGenerator.as_view())),
        path('fetch-api-config/<str:projectName>/<str:filename>', csrf_exempt(RetrieveApiConfig.as_view())),
